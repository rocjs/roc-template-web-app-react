...
export default () => (
  <div className={styles.main}>
    ...
    <div className="wrapper">
      ...
      <p>
        <strong>Feel free to delete</strong> the generated code and components, they are only here
        for your reference.
      </p>
      ...
      <h4>Get styling</h4>
      <p>
        Roc Web React includes CSS and SCSS loaders for your convenience. Just look at the
